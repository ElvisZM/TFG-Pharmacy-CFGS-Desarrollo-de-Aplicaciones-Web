...
@Component({
  selector: 'app-cat-analgesicos',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './cat-analgesicos.component.html',
  styleUrl: './cat-analgesicos.component.scss'
})
export class CatAnalgesicosComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle('Analgésicos y Antiinflamatorios');
  }


  getAllProducts(): void {
    this.datosService.getProductsAnalgesicos().subscribe(
      response => {
