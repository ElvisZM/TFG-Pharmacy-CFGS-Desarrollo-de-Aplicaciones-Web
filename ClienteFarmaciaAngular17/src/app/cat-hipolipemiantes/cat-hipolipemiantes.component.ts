...
@Component({
  selector: 'app-cat-hipolipemiantes',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './cat-hipolipemiantes.component.html',
  styleUrl: './cat-hipolipemiantes.component.scss'
})
export class CatHipolipemiantesComponent implements OnInit{
  ...
  getAllProducts(): void {
    this.datosService.getProductsHipolipemiantes().subscribe(
      response => {
