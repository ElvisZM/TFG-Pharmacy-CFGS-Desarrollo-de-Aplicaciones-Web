...
@Component({
  selector: 'app-cat-suplementos',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './cat-suplementos.component.html',
  styleUrl: './cat-suplementos.component.scss'
})
export class CatSuplementosComponent implements OnInit{
  ...
  getAllProducts(): void {
    this.datosService.getProductsVitaminas().subscribe(
      response => {
