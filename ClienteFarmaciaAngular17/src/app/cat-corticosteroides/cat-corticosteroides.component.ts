...
@Component({
  ...
  templateUrl: './cat-corticosteroides.component.html',
  styleUrl: './cat-corticosteroides.component.scss'
})
export class CatCorticosteroidesComponent implements OnInit{
  ...
  getAllProducts(): void {
    this.datosService.getProductsCorticosteroides().subscribe(
      response => {
