...
@Component({
  selector: 'app-cat-antialergicos',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './cat-antialergicos.component.html',
  styleUrl: './cat-antialergicos.component.scss'
})
export class CatAntialergicosComponent implements OnInit{
  ...
  getAllProducts(): void {
    this.datosService.getProductsAntialergicos().subscribe(
      response => {
